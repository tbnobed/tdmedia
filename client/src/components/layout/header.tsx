        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <nav className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              {user?.isAdmin && (
                <Link href="/admin" className={`${location === '/admin' ? 'border-primary text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`}>
                  Admin
                </Link>
              )}
